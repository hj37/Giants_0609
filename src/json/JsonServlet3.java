	...
	//doGet , doPost 메소드 오버라이딩
		...
		protected void doHandle(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			try {
				...
				dto.setFk_num(Integer.parseInt(jsonObject.get("fk_num").toString()));
				System.out.println(dto.getRef());
				dto.setName((String)jsonObject.get("name"));
				dao.insertrvboard(dto);
				
				dto = dao.getrvBoard(dto.getFk_num());
				...
				jsonObj.put("num",dto.getRef());
				jsonObj.put("fk_num",dto.getFk_num());
